...
class ProductAdmin extends AbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('product_price_in_currency', 'checkbox', array('label' => 'Цена в валюте', 'required' => false))
            ->add('product_price_old', 'integer', array('label' => 'Старая цена', 'required' => false))
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('product_price_in_currency', null, array('label' => 'Цена в валюте', 'editable' => true))
